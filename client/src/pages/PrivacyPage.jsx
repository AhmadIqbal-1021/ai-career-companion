      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-gray-600 dark:text-gray-400">
          <div>
            ...
            <p className="text-sm leading-relaxed">We collect information you provide directly to us, such as your name, email address, and password when you register. We also collect career-related data you enter including job applications, resume text, and notes.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">How We Use Your Information</h2>
            <p className="text-sm leading-relaxed">We use your information to provide and improve CareerAI. Resume text submitted for AI analysis is sent to Google Gemini API and is not stored permanently on our servers.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              ...
              {/* Plain <a> tag — not Link — because mailto is not an internal route */}
              <a
