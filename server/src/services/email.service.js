...
// What is this file?
// Sends emails using Brevo HTTP API.
// Works on Railway because it uses HTTP not SMTP.
...
export const sendPasswordResetEmail = async (email, resetUrl) => {
  ...
  sendSmtpEmail.sender = { 
    ...
    // Note: Brevo lets you use any from address without domain verification
    // on the free tier for transactional emails
  }
